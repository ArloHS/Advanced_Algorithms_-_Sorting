...
public class MergeBenchmark {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Base Merge sort with: " + amountOfTests + " amount of iterations per test.");
        ...
        Helper.writeResultsToFile(RESULTS, "results/BaseMergeSort.csv");
